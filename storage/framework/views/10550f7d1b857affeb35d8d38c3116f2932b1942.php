...
<?php $__env->startSection('titulo','Mostrar registro'); ?>
                                    ...
                                    <div class="col-md-6">                                        
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres" required="" value="<?php echo e($Agenda->nombres); ?>" disabled="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos" required="" value="<?php echo e($Agenda->apellidos); ?>" disabled="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input class="form-control" type="number" name="telefono" placeholder="Telefono: 18491115555" id="telefono" value="<?php echo e($Agenda->telefono); ?>" disabled="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input class="form-control" type="number" name="celular" placeholder="Celular: 18491115555" id="Celular" value="<?php echo e($Agenda->celular); ?>" disabled="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="sexo" value="Masculino" <?php echo e($hombre); ?> disabled="true">
                                                    <span> Masculino </span> 
                                                </label>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="sexo" value="Femenino" <?php echo e($mujer); ?> disabled="true">
                                                    <span>Femenino </span> 
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                         ...
                                         <div class="form-group">
                                           <div class="input-group">
                                             ...
                                             <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo e($Agenda->email); ?>" disabled="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                             ...
                                             <input type="text" name="posicion" class="form-control" placeholder="Posición" value="<?php echo e($Agenda->posicion); ?>" disabled="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                              ...
                                              <input type="number" class="form-control" name="salario" placeholder="salario *" value="<?php echo e($Agenda->salario); ?>" disabled="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="input-group">
                                                ...
                                                <input type="date" name="fechadenacimiento" id="fechadenacimiento" min="1000-01-01"
                                                  max="3000-12-31" class="form-control" value="<?php echo e($Agenda->fechadenacimiento); ?>" disabled="true">                                                   
                                            </div>
                                        </div>


                                    <a href="<?php echo e(route('agenda.edit',$Agenda->id)); ?>" class="redondo btn btn-success btncolorblanco">
...
<?php echo $__env->make('plantilla.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel6\agendatelefonica\resources\views/agenda/show.blade.php ENDPATH**/ ?>